...
JWT_AUTH = {
    ...
    'JWT_RESPONSE_PAYLOAD_HANDLER': 'users.utils.jwt_response_payload_handler',  # 处理登录视图返回值
...
EMAIL_PORT = 25
# 发送邮件的邮箱
EMAIL_HOST_USER = '15055435721@163.com'
# 在邮箱中设置的客户端授权密码
EMAIL_HOST_PASSWORD = 'meiduo12'
# 收件人看到的发件人
EMAIL_FROM = 'python<15055435721@163.com>'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.73.156:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
